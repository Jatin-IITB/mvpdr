...
class PlantVillage(DatasetBase):
    ...
    def __init__(self, root, num_shots):
        ...
        self.origin_classes = sorted(os.listdir(os.path.join(self.dataset_dir, "images")))
        ...
        self.classes = ["apple scab", "apple black rot", "apple cedar rust", "healthy apple leaf", "healthy blueberry leaf",
                        ...
                        "strawberry leaf scorch", "healthy strawberry leaf", "tomato bacterial spot", "tomato early blight",
